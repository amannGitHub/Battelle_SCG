<%@ Page Title="Conference Balance" Language="vb" AutoEventWireup="false" MasterPageFile="~/Registration/Registration.Master" CodeBehind="Balance.aspx.vb" Inherits="Battelle.Balance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="btnNext" runat="server" Text="Next Step>>" CssClass="btn btn-primary" Visible="false" />
