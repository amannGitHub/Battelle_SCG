<%@ Page Title="Short Course Proposal Submission" Language="vb" AutoEventWireup="false" MasterPageFile="~/Registration/Registration.Master" CodeBehind="ShortCourseProposal.aspx.vb" Inherits="Battelle.ShortCourseProposal" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Src="~/ParticipationIDLogin.ascx" TagPrefix="uc1" TagName="ParticipationIDLogin" %>
<%@ Register Src="~/Registration/ShortCourseProposalTerms.ascx" TagPrefix="uc1" TagName="TermsConditions" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="PanelClosed" runat="server" Visible="false">
        <asp:Label ID="lblClosed" runat="server" Text="Short Course Submission is currently closed."></asp:Label>
    </asp:Panel>
    ...
    <asp:Panel ID="PanelTerms" runat="server" Visible="True">
        <h3>Course Submission Terms & Conditions</h3>
...
ORDER BY LookupCountry.ListOrder, LookupStateProvince.StateProvinceName"></asp:SqlDataSource>
    ...
    <strong>
        <asp:HyperLink ID="lnkConferenceEmail" runat="server">the conference email address</asp:HyperLink></strong>.
                ...
                <p>
                    <strong>As the person submitting this form, you are  automatically listed as the POC and Instructor for the demonstration</strong>.  
                    ...
                    and then follow the  instructions under the Co-Instructors box to change the POC designation.
                </p>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:TextBox ID="txtTitle" runat="server" CssClass="form-control" MaxLength="500"></asp:TextBox>
                                <br />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <br />
                                <asp:Label ID="lblCourseLength" runat="server" Text="*Course Length" AssociatedControlID="rblCourseLength"></asp:Label><br />
                                <i>Courses will be scheduled for 4- or 8-hour increments. Final course length will be determined by the Conference Office based on the final number of 
                                    courses accepted and classrooms available. The Conference Office may also request that your course combine with another course with similar/complimentary subject matter.</i>
                                <asp:RadioButtonList ID="rblCourseLength" runat="server" CssClass="radio">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <br />
                                <asp:Label ID="lblLaptopsYN" runat="server" Text="*Will participants need to bring laptops for classroom exercises?" AssociatedControlID="rblLaptopsYN"></asp:Label><br />

                                <asp:RadioButtonList ID="rblLaptopsYN" runat="server" CssClass="radio">
                                    <asp:ListItem Value="True" Text="YES, participants will need laptops."></asp:ListItem>
                                    <asp:ListItem Value="False" Text="NO, participants will not need laptops."></asp:ListItem>
                                </asp:RadioButtonList>
                                <br />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <br />
                                <asp:Label ID="lblSoftwareYN" runat="server" Text="*Will participants be required to download and use any specialty software?" AssociatedControlID="rblSoftwareYN"></asp:Label><br />
                                <br />
                                <i>By requiring the use of specialty software, you acknowledge your permission and any required license to use and distribute it.</i>
                                <asp:RadioButtonList ID="rblSoftwareYN" runat="server" CssClass="radio">
                                    <asp:ListItem Value="True" Text="YES, I will be providing specialty software and have permission/license to use/distribute it."></asp:ListItem>
                                    <asp:ListItem Value="False" Text="NO, specialty software will not be used/required."></asp:ListItem>
                                </asp:RadioButtonList>
                                <br />
                                <i>If yes, please list the required software and explain how it will be distributed to attendees.</i>
                                <asp:TextBox ID="txtSoftware" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="5"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <br />
                                <asp:Label ID="lblInternetYN" runat="server" Text="*Will Internet access be required for the course Instructor or attendees’ use during the course?" AssociatedControlID="rblInternetYN"></asp:Label><br />
                                <br />
                                <i>Internet access is an additional cost to the Conference and will be deducted from course revenue.</i>
                                <asp:RadioButtonList ID="rblInternetYN" runat="server" CssClass="radio">
                                    <asp:ListItem Value="True" Text="YES, internet access is required."></asp:ListItem>
                                    <asp:ListItem Value="False" Text="NO, internet access is not required."></asp:ListItem>
                                </asp:RadioButtonList>
                                <br />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <br />
                                <asp:Label ID="lblSupplementaryMaterialsYN" runat="server" Text="*In addition to the course handbook, will supplementary printed or digital materials be provided to participants?" AssociatedControlID="rblSupplementaryMaterialsYN"></asp:Label><br />
                                <br />
                                <asp:RadioButtonList ID="rblSupplementaryMaterialsYN" runat="server" CssClass="radio">
                                    <asp:ListItem Value="True" Text="YES, supplementary materials will be provided."></asp:ListItem>
                                    <asp:ListItem Value="False" Text="NO, supplementary materials will not be provided."></asp:ListItem>
                                </asp:RadioButtonList>
                                <br />
                                <i>If yes, please list the supplementary materials:</i>
                                <asp:TextBox ID="txtSupplementaryMaterials" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="5"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <br />
                                <asp:Label ID="lblObjective" runat="server" Text="Course Objective." AssociatedControlID="txtObjective"></asp:Label>
                                Provide only <b>a sentence or two</b> that will give an overview of the information you believe the participants will gain from the course. 
                                Describe the audience that would benefit most from the material you will be presenting (e.g., engineers, site managers, regulators).
                                <br /><br />
                                <i>For example: “Present information on collecting, evaluating, and interpreting data on vapor intrusion. The potential audience includes 
                                environmental professionals, state and federal regulators engaged in vapor intrusion issues, property developers, and community stakeholders.”</i>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <asp:Label ID="lblOverview" runat="server" Text="Course Overview." AssociatedControlID="txtOverview"></asp:Label>
                                Provide a concise <b>(maximum 300 words)</b> overview of the topic, a description of the technology or approach being taught, and the situations in 
                                which it would be applicable.
                                <br />
                                <asp:TextBox ID="txtOverview" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="10"></asp:TextBox>
                                <br />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <asp:Label ID="lblAgenda" runat="server" Text="Draft Agenda." AssociatedControlID="txtAgenda"></asp:Label>
                                This is meant to be a high-level overview and should not exceed 10 numbered topics of your main points.
                                <br />
                                <asp:TextBox ID="txtAgenda" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="15"></asp:TextBox>
                                <br />
                            </div>
                        </div>
                    </div>
            ...
            <asp:Panel ID="PanelAbstractConfirmation" runat="server" Visible="False">
                <h3>Thank you. The Short Course Proposal you submitted has been received and recorded as shown below.</h3>
                <br />
                <br />
                ...
                The person listed as the Point-of-Contact (POC) Instructor will also receive a confirmation email. Only the POC will be contacted from this point forward with information related to this proposal, including the final acceptance decision.<br />
                <br />

                <b>Note:&nbsp;No financial  assistance is available to support registration or other costs of attending the
                    <asp:Literal ID="ltlConferenceType" runat="server"></asp:Literal>. All instructors and co-instructors are expected to register  and pay the applicable technical-program registration fees. 
                    This policy is  necessary because registration fees are the major source of funding for the
                    <asp:Literal ID="ltlConferenceType2" runat="server"></asp:Literal>
                    and a significant percentage of registrants will make presentations.</b></p>
                <h4>Short Course Proposal Inquiries</h4>
                Questions about Short Course Proposal submittal should be addressed to
                <asp:HyperLink ID="lnkSubjectEmail2" runat="server"></asp:HyperLink>, with the subject line "Short Course Proposal Inquiry," or contact Gina Melaragno (Battelle) at 614-424-7866.
                <br />
                <br />
                <%--In
                ...
                <h4>Short Course Proposal Summary</h4>
                <asp:Label ID="LabelAbstractConfirmationResult" runat="server"></asp:Label>
                <br />
                Submitting another Short Course Proposal? Select an option below:<br />
                <ul>
                    <li>
