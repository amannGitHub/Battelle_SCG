<%@ Page Title="Registration and Short Course Selection Confirmation" Language="vb" AutoEventWireup="false" MasterPageFile="~/Registration/Registration.Master" CodeBehind="ShortCourseConfirm.aspx.vb" Inherits="Battelle.ShortCourseConfirm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="PanelSelections" runat="server">
        ...
        <EmptyDataTemplate>
            You are only signed up to attend Short Courses.
        </EmptyDataTemplate>
        <ItemTemplate>
            Registration Date:
        ...
        <h3>Short Course Selections</h3>
        <asp:SqlDataSource ID="SqlDataSourceShortCourse" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="ShortCourseRegistrationGetByPersonID" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:Parameter Name="ConferenceID" Type="Int32" />
                <asp:CookieParameter Name="PersonID" CookieName="PersonID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:GridView ID="gvCourses" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceShortCourse" GridLines="None" ShowHeader="False">
            <Columns>
                <asp:TemplateField HeaderText="GroupName" SortExpression="GroupName">
                    <ItemTemplate>
                        <h4><asp:Label ID="Label0" runat="server" Text='<%# Bind("GroupName") %>'></asp:Label></h4>
                        <b><asp:Label ID="Label1" runat="server" Text='<%# Bind("CourseName")%>'></asp:Label></b><br />
                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("CoursePresenter")%>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
    ...
    <asp:Panel ID="PanelCheck" runat="server" Visible="false">
        <hr />
        <h3>Note: Payment is required to confirm your <asp:Literal ID="ltlRegType" runat="server" Text="Short Course reservation"></asp:Literal>.</h3>
