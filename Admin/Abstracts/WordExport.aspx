<%@ Page Title="Abstract Export" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/Admin.Master" CodeBehind="WordExport.aspx.vb" Inherits="Battelle.WordExport" %>
...
<asp:SqlDataSource ID="SqlDataSourceAbstracts" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="AbstractExport" SelectCommandType="StoredProcedure">
    <SelectParameters>
        ...
        <asp:Button ID="btnExport" runat="server" Text="Save Word Files" Visible="False" />
