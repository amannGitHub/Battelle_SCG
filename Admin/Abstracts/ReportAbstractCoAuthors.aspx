<%@ Page Title="Abstract Co-Author Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/AdminBattelle.Master" CodeBehind="ReportAbstractCoAuthors.aspx.vb" Inherits="Battelle.ReportAbstractCoAuthors"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <br />
    <asp:SqlDataSource ID="SqlDataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="AbstractAuthorsByConference" SelectCommandType="StoredProcedure">
        <SelectParameters>
    ...
    <telerik:RadGrid ID="RadGrid1" runat="server" AllowSorting="True" DataSourceID="SqlDataSourceReport" GroupPanelPosition="Top" CellSpacing="-1" GridLines="Both">
        <ExportSettings OpenInNewWindow="True" FileName="AbstractCoAuthors" HideStructureColumns="True">
        <Excel Format="Xlsx" />
        </ExportSettings>
        ...
        <MasterTableView DataSourceID="SqlDataSourceReport" AutoGenerateColumns="False">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="Presenter" FilterControlAltText="Filter Presenter column" HeaderText="Presenter" SortExpression="Presenter" UniqueName="Presenter">
                </telerik:GridBoundColumn>
