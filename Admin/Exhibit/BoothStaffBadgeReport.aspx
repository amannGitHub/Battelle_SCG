<%@ Page Title="Onsite Booth Staff Badge Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/Admin.Master" CodeBehind="BoothStaffBadgeReport.aspx.vb" Inherits="Battelle.BoothStaffBadgeReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <br />
    <asp:SqlDataSource ID="SqlDataSourceAttendees" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="BoothStaffOnSiteBadgeReport" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlConfList" Name="ConferenceID" PropertyName="SelectedValue" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:Button Id="btnRefresh" Text="Refresh" OnClick="btnRefresh_Click" runat="server" Visible="false" /><br />
    Badges given: <asp:Label ID="lblBadgeCount" runat="server"></asp:Label><br />
    Need badges:
    ...
    <asp:SqlDataSource ID="SqlDataSourceBadged" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="BoothStaffOnSiteBadgesGiven" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlConfList" Name="ConferenceID" PropertyName="SelectedValue" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
