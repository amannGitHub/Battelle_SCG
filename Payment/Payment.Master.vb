Public Class PaymentMaster
    ...
    Protected Sub ConferenceFromURL_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles ConferenceFromURL.Load
        'Me.lblConferenceName.Text = ConferenceFromURL.ConferenceShortName
        Me.lblConferenceName2.Text = ConferenceFromURL.ConferenceShortName
        'Me.lnkReturn.NavigateUrl = ConferenceFromURL.ConferenceAbstractReturnURL
    End Sub
