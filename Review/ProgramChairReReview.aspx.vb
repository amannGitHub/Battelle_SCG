Public Class ProgramChairReReview
    ...
    Protected Sub SqlDataSourceReview_Selected(sender As Object, e As SqlDataSourceStatusEventArgs) Handles SqlDataSourceReview.Selected
        ...
        'If abstract is locked from editing by all program chair re-review staff, hide review form
        If hdnAbstractTypeID.Value.ToString.Contains("4") Then
    ...
    Protected Sub btnFinalize_Click(sender As Object, e As EventArgs) Handles btnFinalize.Click
        ...
        If bFinalize = True Then
            ...
            Dim sURL As String = "~/" & ConferenceControl.ConferenceURLString & "/review/returned"
