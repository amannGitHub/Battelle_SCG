<%@ Page Title="Program Chair Re-Review" Language="vb" AutoEventWireup="false" CodeBehind="ProgramChairReReview.aspx.vb" MasterPageFile="~/Review/Review.Master" Inherits="Battelle.ProgramChairReReview" %>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        ...
                        <asp:FormView ID="FormViewReview" runat="server" DataKeyNames="AbstractReviewID" DataSourceID="SqlDataSourceReview" RenderOuterTable="False" DefaultMode="Edit">
                            ...
                            <ItemTemplate>
                                ...
                                <br />
                                Decline for Conference: <asp:CheckBox ID="CheckBox2" runat="server" Checked='<%# Bind("Decline") %>' Enabled="false" AutoPostBack="true" OnCheckedChanged="DeclineCheckBox_CheckedChanged" />
                                <br />
                                Review Date:
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <asp:Panel ID="PanelFinalize" runat="server" Visible="false">
                            ...
                            <asp:HyperLink ID="lnkNeedsEdits" runat="server" CssClass="btn btn-warning">This Review Requires Further Discussion/Edits</asp:HyperLink>
                             <!-- keep original prog chair SP, review type is not changed in Final Update -->
