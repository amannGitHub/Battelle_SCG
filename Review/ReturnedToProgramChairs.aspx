<%@ Page Title="Returned to Program Chairs" Language="vb" AutoEventWireup="false" MasterPageFile="~/Review/Review.Master" CodeBehind="ReturnedToProgramChairs.aspx.vb" Inherits="Battelle.ReturnedToProgramChairs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   <a name="toreview" style="position:relative; top:-240px; display: block;"></a> <h1><%=Page.Title%></h1>
    ...
    <asp:SqlDataSource ID="SqlDataSourceRoles" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="AbstractReviewRoleGet" SelectCommandType="StoredProcedure">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <asp:SqlDataSource ID="SqlDataSourceToReview" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="AbstractReReviewProgramChairAbstractsGet" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:Parameter Name="ConferenceID" Type="Int32" />
                        <asp:CookieParameter Name="PersonID" CookieName="PersonID" Type="Int32" />
                    </SelectParameters>
                ...
                <asp:GridView ID="gvToReview" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="AbstractID" DataSourceID="SqlDataSourceToReview" CssClass="table table-striped" GridLines="None">
                    <Columns>
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <itemtemplate>
                                    <asp:HyperLink ID="viewID" runat="server" Text="Review" NavigateUrl='<%#GetRouteUrl("AbstractsProgramChairReReviewAbstractRoute", New With {
    ...
    <div class="panel panel-info">
            ...
            <div class="panel-body">
                <asp:SqlDataSource ID="SqlDataSourceToFinalize" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="AbstractReReviewProgramChairToFinalizeGet" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:Parameter Name="ConferenceID" Type="Int32" />
                        <asp:CookieParameter Name="PersonID" CookieName="PersonID" Type="Int32" />
                    </SelectParameters>
    ...
    <div class="panel panel-success">
            ...
            <div class="panel-body">
                <asp:SqlDataSource ID="SqlDataSourceFinalized" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="AbstractReReviewProgramChairFinalizedGet" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:Parameter Name="ConferenceID" Type="Int32" />
                        <asp:CookieParameter Name="PersonID" CookieName="PersonID" Type="Int32" />
                    </SelectParameters>
    ...
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            ...
            <small>Jump to: <a href="#toreview">To Review</a> &nbsp; <a href="#myreviews">My Reviews</a> &nbsp; <a href="#finalized">Finalized</a> &nbsp; <a href="#returned">Returned</a></small>
